...
function defineDAO() {
	...
	switch (testName) {
		...
		case "GrowingCircles":
			genericDAO = new GrowingCirclesDAO(db, patientUID);
			break;

		case "Symbols":
			genericDAO = new SymbolsDAO(db, patientUID);
			break;

		case "FullBars":
			genericDAO = new FullBarsDAO(db, patientUID);
			break;

		case "FreeDraw":
			forFreeDraw = true;
			genericDAO = new FreeDrawDAO(db, patientUID);
			break;
